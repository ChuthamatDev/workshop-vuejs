        ...
        <v-card class="auth-card pa-8 pa-md-10" elevation="2">
          ...
          <div class="text-center mb-8">
            <div class="auth-logo mb-4">
              <v-icon color="indigo" large>mdi-lock-open-outline</v-icon>
            </div>
            <h2 class="auth-title font-weight-black mb-1">Sign In</h2>
          ...
          <div class="text-center mt-6">
            <span class="grey--text text--darken-1">Don't have an account?</span>
            <router-link to="/register" class="auth-link ml-1">Sign up here</router-link>
          </div>
        </v-card>
      </v-col>
    </v-row>
